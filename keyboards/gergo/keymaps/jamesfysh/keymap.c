...
[BASE] = LAYOUT_gergo(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_NO,   KC_NO,           KC_NO,   KC_NO,   KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_MTSL, KC_RSFT,
...
[SYMB] = LAYOUT_gergo(
    ...
    KC_TRNS, KC_F11,  KC_F12,  KC_LBRC, KC_RBRC, KC_NO,   KC_NO,   KC_NO,           KC_NO,   KC_NO,   KC_GRV,  KC_MINS, KC_EQL,  KC_BSLS, KC_MTSL, KC_TRNS,
